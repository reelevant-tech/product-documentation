...
Without this option, a countdown set to "31 Dec at 23:59 UTC" ends at 00:59 on 1 Jan for a user in Paris (UTC+1) and at 08:59 on 1 Jan in Tokyo (UTC+9). With the option enabled, the countdown ends at 23:59 local time for everyone — so both the French and Japanese users see it expire at their own midnight.
