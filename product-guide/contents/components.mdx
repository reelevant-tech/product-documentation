...
<CardGroup cols={2}>
  ...
  <Card title="Image Composition" icon="images" href="/product-guide/contents/components/image-composition">
    Beta — combine several images into one visual, with background removal.
  </Card>
