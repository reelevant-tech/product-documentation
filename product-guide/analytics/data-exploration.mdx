...
Available measures include metrics from workflow events (displays, clicks, openers) and purchase events (conversions, revenue, buyer count). See the full list in the [dashboards documentation](/product-guide/analytics/dashboards).
