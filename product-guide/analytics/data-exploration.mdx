...
Available measures include Workflow event metrics (impressions, reached individuals, displays, and clicks) and purchase metrics (conversions, revenue, and buyers). See the [measures and dimensions reference](/product-guide/analytics/measures-and-dimensions).
