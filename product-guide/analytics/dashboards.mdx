...
| **Analysis period** | Select the date range for the data. Most dashboards open on the last week. |
...
<Info>
  Uplift, [Customer Impact](/advanced-guide/analytics/customer-impact) and [Adoption](/advanced-guide/analytics/adoption) open on the last three months instead. These dashboards compare groups of customers, which needs a longer period to hold enough purchases. Customer Impact refuses any period shorter than one month.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Audience & Interactions" icon="users" href="/product-guide/analytics/dashboards/audience">
    Reached individuals, impressions, clickers, and engagement rates.
  </Card>
  ...
  <Card title="Usage" icon="chart-bar" href="/product-guide/analytics/dashboards/usage">
    Subscription consumption — impressions or reached individuals, quota, and usage by team.
  </Card>
</CardGroup>
