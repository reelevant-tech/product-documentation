...
<Tip>
  Click **Explore data** to open the [Data Exploration](/platform-guide/analytics/data-exploration) page with the current filters pre-applied.
</Tip>

## Available Dashboards

<CardGroup cols={2}>
  <Card title="Performance" icon="gauge-high" href="/platform-guide/analytics/dashboards/performance">
    Impressions, clicks, CTR, and content generation metrics.
  </Card>
  <Card title="Audience & Interactions" icon="users" href="/platform-guide/analytics/dashboards/audience">
    Unique visitors, openers, clickers, and engagement rates.
  </Card>
  <Card title="Individualization" icon="bullseye" href="/platform-guide/analytics/dashboards/individualization">
    Personalization lift — individualized vs. default content metrics.
  </Card>
  <Card title="Conversions" icon="cart-shopping" href="/platform-guide/analytics/dashboards/conversions">
    Conversion tracking, revenue, and attribution metrics.
  </Card>
  <Card title="Uplift" icon="arrow-trend-up" href="/platform-guide/analytics/dashboards/uplift">
    Incremental value from personalization — click, conversion, and revenue uplift.
  </Card>
  <Card title="Usage" icon="chart-bar" href="/platform-guide/analytics/dashboards/usage">
