...
Open **DataHub** in the sidebar, then choose **Datagraph**. You will see four pages:
...
| **Entity groups** | Sets of Entities that promise the same answer fields, so a Workflow can swap one for another. |
