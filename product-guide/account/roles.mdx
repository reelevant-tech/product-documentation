...
| Check mark | **Own teams** | Users on resources that belong to their [teams](/product-guide/account/teams). The standard [team hierarchy](/product-guide/account/teams#team-hierarchy) rules apply. |
| Up arrow | **Own teams and their parent teams** | Same as **Own teams**, plus resources in every parent team above the user's teams. This applies even when a team is [excluded from ancestor inheritance](/product-guide/account/teams#exclude-from-ancestor-inheritance). |
