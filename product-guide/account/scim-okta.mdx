...
<Steps>
  <Step title="Open the Provisioning tab">
    Open the application, go to **Provisioning**, and click **Configure API Integration**.
  </Step>
  ...
  <Step title="Test the connection">
    Click **Test API Credentials**. Okta checks what Reelevant supports and confirms the connection.
