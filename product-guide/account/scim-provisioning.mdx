...
Automatic user provisioning lets your identity provider (the tool your company uses to manage staff accounts, such as Okta or Microsoft Entra ID) manage Reelevant accounts for you.
