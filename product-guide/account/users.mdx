...
![Users listing page showing user table with roles and teams](/images/account/users-listing-v2.png)
...
<Info>
  If your company uses [automatic provisioning (SCIM)](/product-guide/account/scim-provisioning), accounts are created, updated, and removed by your identity provider. You do not need to invite or delete those people by hand.
</Info>
