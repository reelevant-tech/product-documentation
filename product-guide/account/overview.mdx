...
| **Team** | An organizational unit for grouping users and controlling access to [workflows](/platform-guide/workflows/overview), [contents](/platform-guide/contents/overview), and [datasources](/platform-guide/datahub/overview). Teams can be organized hierarchically. |
