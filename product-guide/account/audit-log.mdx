...
The audit log is a read-only record of everything that happens to identities in your company: logins, single sign-on, automatic provisioning, and changes to users, roles, and [Teams](/product-guide/account/teams).
...
Each entry records the time, who did it (a person, your identity provider, or Reelevant itself), what it affected, whether it succeeded, and an error reference when it failed.
