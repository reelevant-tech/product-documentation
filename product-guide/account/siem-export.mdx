...
![SIEM export settings page with the collector, delivery and delivery status sections](/images/account/siem-export-settings.png)
...
<Steps>
  <Step title="Open the SIEM export settings">
    ...
    ![Collector section with the Enable SIEM export switch, Collector URL, Format and Authorization header fields](/images/account/siem-export-settings.png)
  </Step>
...
![Delivery status section showing a Healthy badge with the delivered up to and last successful delivery dates](/images/account/siem-export-delivery-status.png)
...
![Delivery status section showing a Paused badge and the error returned by the collector](/images/account/siem-export-delivery-status-paused.png)
