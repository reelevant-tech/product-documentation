...
![Channel picker showing the RCS and WhatsApp Channels at the bottom of the list](/images/workflows/channel-picker-messaging.png)
...
![Workflow canvas with an RCS Card Image Node and a WhatsApp Header Image Node](/images/workflows/messaging-entrypoint-nodes.png)
