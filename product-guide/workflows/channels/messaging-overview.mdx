...
There is no "RCS" or "WhatsApp" Channel in the Channel picker. You build the Workflow with an [Email Channel](/product-guide/workflows/channels/email), because it renders exactly what a messaging platform needs — a personalised visual served from a link.

<Steps>
  <Step title="Build the Workflow">
    Add an Email Channel, connect your [Data Nodes](/product-guide/workflows/data-nodes) and [Logic Nodes](/product-guide/workflows/logic-nodes), and finish with a [Visual Content](/product-guide/workflows/output-nodes/visual-content) Output Node.
  </Step>
