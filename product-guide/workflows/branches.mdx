...
A **branch** is a unique execution path through a workflow, from a [channel](/platform-guide/workflows/channels) node to an [output node](/platform-guide/workflows/output-nodes). When a user triggers a workflow, the engine evaluates [conditions](/platform-guide/workflows/logic-nodes/conditions) and data to determine which branch to follow, then returns the output at the end of that branch.
