...
The **branch categories** are a hierarchical tree of categories that you define in [Analytics Settings](/product-guide/analytics/settings). They provide a consistent vocabulary for qualifying branches across all your workflows.
