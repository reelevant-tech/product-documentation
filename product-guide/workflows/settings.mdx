...
<Note>
  Branch categories are now configured together with tags in [Analytics Settings](/product-guide/analytics/settings), so your whole nomenclature lives in one place.
</Note>
