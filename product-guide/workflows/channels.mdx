...
<Steps>
  ...
  <Step title="Position and connect">
    The channel node appears on the canvas. Connect it downstream to [data nodes](/platform-guide/workflows/data-nodes), [logic nodes](/platform-guide/workflows/logic-nodes), and eventually to an [output node](/platform-guide/workflows/output-nodes) to complete the branch.
  </Step>
</Steps>
