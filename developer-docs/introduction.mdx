...
<CardGroup cols={2}>
  <Card title="Data Collection" icon="chart-line" href="/developer-docs/data-collection/overview">
    Collect website and app behaviour with the tracking tag, Google Tag Manager, or the mobile SDKs.
  </Card>
...
| [Data collection](/developer-docs/data-collection/overview) | Send behavioural events from websites and apps into a tracking Datasource |
| [Public IPs](/advanced-guide/datahub/public-ips) | CIDRs to allowlist for Datasource fetches and Content image fetches |
