...
keywords: ["SOC 2", "GDPR", "password policy", "audit logs", "audit trail", "SCIM provisioning", "subprocessors", "vendors", "security contact", "vulnerability disclosure"]
---
...
The current SOC 2 Type 2 report, and those of our hosting providers, are available through the **[Trust Centre](https://trust.reelevant.com)**.
...
Minimum length, character requirements, expiry and lockout thresholds can be tightened to match your own policy, or replaced entirely by delegating authentication to your identity provider through SSO.
...
OVHcloud, Google Cloud and AWS are our only subprocessors. No other party processes customer data in the delivery of the service.
...
- **Security logs centrally collected and retained for 1 year** in access-controlled storage
