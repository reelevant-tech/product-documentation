...
keywords: ["SOC 2", "GDPR", "audit logs", "subprocessors", "vendors", "security contact", "vulnerability disclosure"]
---
...
| Vendor | Service | Role |
|--------|---------|------|
| **OVHcloud** | Bare metal servers | Hosts the platform: application services, databases, and event processing. EU data residency |
| **Google Cloud** | BigQuery | Analytics warehouse used for event storage and reporting queries |
| **AWS** | Route 53 (DNS) | Public DNS resolution for Reelevant domains — no customer data |
