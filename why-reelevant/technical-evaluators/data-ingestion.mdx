...
Outbound Datasource fetches and remote Content image fetches originate from published Reelevant public IPs. Allow those addresses if your hosts restrict inbound traffic.

See [Public IPs](/advanced-guide/datahub/public-ips) for when they are used and the published list.
