...
Le provisionnement entrant utilise des tokens bearer propres à une entreprise, et non des tokens OAuth utilisateur. Voir [Provisionnement SCIM 2.0](/fr/developer-docs/api-reference/scim).
