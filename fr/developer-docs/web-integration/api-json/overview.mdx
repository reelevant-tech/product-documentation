...
<Steps>
  ...
  <Step title="Construire un Workflow avec un Output Node JSON Template">
    Ajoutez un Output Node **JSON Template** à votre Workflow. Sélectionnez le template que vous avez créé, puis liez chaque variable à un champ de Datasource — soit comme valeur scalaire, soit comme tableau (pour les listes de produits, les recommandations, etc.).
  </Step>
