...
<Note>
  Les catégories de Branch se configurent avec les tags dans les [paramètres Analytics](/fr/product-guide/analytics/settings), regroupant toute la nomenclature de qualification au même endroit.
</Note>
