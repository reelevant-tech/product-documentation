...
<Info>
  Lorsque l'Entity appartient à un [Datagraph Entity Group](/fr/advanced-guide/datahub/datagraph/entity-groups) Live, la publication échoue avec *Entity group contract violated* si les nouvelles colonnes de sortie ne respectent plus le contrat du groupe. Une Entity présente dans un groupe Live ne peut pas non plus être supprimée.
</Info>

## Partager un contrat entre plusieurs Entities

Plusieurs Entities qui répondent à la même question pour des segments différents — un algorithme de recommandation par Entity, par exemple — peuvent être liées à un Datagraph Entity Group. Le groupe déclare les champs que chaque membre doit retourner, et vérifie la version Live de chaque membre. Voir [Datagraph Entity Groups](/fr/advanced-guide/datahub/datagraph/entity-groups).
...
<CardGroup cols={2}>
  <Card title="Entity Groups" icon="layer-group" href="/fr/advanced-guide/datahub/datagraph/entity-groups">
    Liez plusieurs Entities à un même contrat de sortie.
  </Card>
