...
Les destinations sont configurées dans les **options de stockage** de la Datasource. Chaque destination spécifie :

| Paramètre | Description |
|-----------|-------------|
| **Dataset** | Le dataset cible (schéma de base de données) dans lequel la table réside. |
| **Table name** | Le nom de la table. Supporte le placeholder `{COMPANY_ID}` pour l'isolation multi-tenant. |
