...
<Info>
  Pour un formatage avec la locale et le code devise provenant de variables, voir [Format Currency avec variables Locale et Devise](/api-reference/transformations/format-currency-locale-currency).
</Info>
