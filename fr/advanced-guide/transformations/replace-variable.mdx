...
<Info>
  Cette transformation est similaire à [Replace](/api-reference/transformations/replace), mais utilise une variable pour la valeur de remplacement au lieu d'une chaîne statique.
</Info>
