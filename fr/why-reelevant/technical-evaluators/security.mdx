...
keywords: ["SOC 2", "RGPD", "logs d'audit", "sous-traitants", "fournisseurs", "contact sécurité", "divulgation de vulnérabilité"]
---
...
|-------------|---------|------|
| **OVHcloud** | Serveurs bare metal | Héberge la plateforme : services applicatifs, bases de données et traitement des événements. Résidence des données en UE |
| **Google Cloud** | BigQuery | Entrepôt analytique utilisé pour le stockage des événements et les requêtes de reporting |
| **AWS** | Route 53 (DNS) | Résolution DNS publique des domaines Reelevant — aucune donnée client |
