...
keywords: ["SOC 2", "RGPD", "politique de mot de passe", "logs d'audit", "journal d'audit", "provisionnement SCIM", "sous-traitants", "fournisseurs", "contact sécurité", "divulgation de vulnérabilité"]
---
...
Le rapport SOC 2 Type 2 en vigueur, ainsi que ceux de nos hébergeurs, sont disponibles via le **[Trust Centre](https://trust.reelevant.com)**.
...
Longueur minimale, exigences de complexité, expiration et seuils de verrouillage peuvent être renforcés pour correspondre à votre propre politique, ou entièrement remplacés en déléguant l'authentification à votre fournisseur d'identité via le SSO.
...
OVHcloud, Google Cloud et AWS sont nos seuls sous-traitants. Aucun autre acteur ne traite de données clients dans le cadre de la fourniture du service.
...
- **Logs de sécurité collectés de manière centralisée et conservés 1 an** dans un stockage à accès contrôlé
