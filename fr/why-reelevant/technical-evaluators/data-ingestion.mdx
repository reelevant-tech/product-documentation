...
Toutes les configurations de source sont gérées via l'interface de la plateforme — aucun code requis. Pour la gestion programmatique, voir la [référence API](/developer-docs/api-reference/introduction).
