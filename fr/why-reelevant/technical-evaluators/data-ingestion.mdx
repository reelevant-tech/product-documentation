...
Les récupérations Datasource sortantes et les images de Content distantes partent des IPs publiques Reelevant publiées. Autorisez ces adresses si vos hôtes restreignent le trafic entrant.

Consultez [IPs publiques](/fr/advanced-guide/datahub/public-ips) pour les cas d'usage et la liste publiée.
