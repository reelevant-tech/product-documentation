...
<CardGroup cols={2}>
  ...
  <Card title="Composition d'images" icon="images" href="/fr/product-guide/contents/components/image-composition">
    Bêta — combinez plusieurs images en un seul visuel, avec détourage.
  </Card>
