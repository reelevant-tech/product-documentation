...
Lorsqu'une variable est liée, vous pouvez appliquer des [Transformations](/api-reference/transformations/introduction) pour formater la valeur — par exemple, formater une date, arrondir un nombre ou convertir une devise. Voir le composant [Text](/fr/product-guide/contents/components/text) pour les détails sur les transformations.
