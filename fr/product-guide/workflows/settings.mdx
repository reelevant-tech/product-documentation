...
<Note>
  Les catégories de Branches se configurent avec les tags dans les [paramètres Analytics](/fr/product-guide/analytics/settings), pour regrouper toute votre nomenclature au même endroit.
</Note>
