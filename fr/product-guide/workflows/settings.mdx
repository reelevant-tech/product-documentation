...
<Steps>
  ...
  <Step title="Configurer les variables">
    ...
    - **Is Array** — Activez si cette variable doit récupérer toutes les valeurs de la Datasource (ex. une liste de produits). Laissez désactivé pour les valeurs scalaires (ex. un score de fidélité unique).
  </Step>
  <Step title="Enregistrer">
...
| **Is Array** | Lorsque activé, le moteur utilise le mapping automatique pour itérer sur toutes les lignes de la Datasource. Lorsque désactivé, il récupère une seule valeur. |
