...
<Steps>
  ...
  <Step title="Choisir une variable de redirection au clic (optionnel)">
    Utilisez le menu **Variable de redirection au clic** pour choisir la variable qui contient une URL (ex. `productUrl`). Lorsque le Workflow est appelé en mode clic, il redirige le visiteur vers cette URL et enregistre le clic.
