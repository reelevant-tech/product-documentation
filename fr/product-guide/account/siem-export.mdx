...
![Page des paramètres de l'export SIEM avec les sections collecteur, envoi et état des envois](/images/account/siem-export-settings.png)
...
<Steps>
  <Step title="Ouvrir les paramètres de l'export SIEM">
    ...
    ![Section collecteur avec l'interrupteur d'activation, l'URL du collecteur, le format et l'en-tête d'autorisation](/images/account/siem-export-settings.png)
  </Step>
...
![Section État des envois affichant le badge Opérationnel avec les dates de livraison](/images/account/siem-export-delivery-status.png)
...
![Section État des envois affichant le badge En pause et l'erreur renvoyée par le collecteur](/images/account/siem-export-delivery-status-paused.png)
