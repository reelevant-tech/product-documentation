...
La portée se règle par ressource **et** par action. Un rôle peut donc lire les Datasources des Teams parents tout en ne gérant les Workflows que dans les Teams de l'utilisateur.
