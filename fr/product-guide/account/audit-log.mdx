...
Le journal d'audit est un relevé en lecture seule de tout ce qui touche aux identités de votre entreprise : connexions, authentification unique, provisionnement automatique et modifications des utilisateurs, des rôles et des [Teams](/fr/product-guide/account/teams).
...
Chaque entrée enregistre l'heure, l'auteur (une personne, votre fournisseur d'identité ou Reelevant), ce qui est concerné, le résultat, et une référence d'erreur en cas d'échec.
