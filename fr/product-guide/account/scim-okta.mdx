...
<Steps>
  <Step title="Ouvrir l'onglet Provisioning">
    Ouvrez l'application, allez dans **Provisioning** et cliquez sur **Configure API Integration**.
  </Step>
  ...
  <Step title="Tester la connexion">
    Cliquez sur **Test API Credentials**. Okta vérifie ce que Reelevant prend en charge et confirme la connexion.
