...
| Flèche vers le haut | **Own teams and their parent teams** | Comme **Own teams**, plus les ressources de chaque Team parent situé au-dessus des Teams de l'utilisateur. Cela s'applique même lorsqu'un Team est [exclu de l'héritage ascendant](/fr/product-guide/account/teams#exclude-from-ancestor-inheritance). |
...
<Tip>
  Cela permet d'ouvrir les données partagées sans ouvrir tout le reste. Activez d'abord **Exclude from ancestor inheritance** sur le Team de la marque pour que ses utilisateurs ne voient plus les ressources du Team marché parent. Donnez ensuite au rôle de marque **Datasource → Read** et **Query** en **Own teams and their parent teams**, et laissez **Workflow** en **Own teams**. Les utilisateurs de la marque utilisent alors les Datasources du Team marché, tout en ne voyant que les Workflows de leur marque.
</Tip>
