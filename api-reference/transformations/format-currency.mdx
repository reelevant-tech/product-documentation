...
<Info>
  For formatting with a locale from a variable, see [Format Currency with Locale Variable](/api-reference/transformations/format-currency-locale).
  For formatting with both locale and currency from variables, see [Format Currency with Locale and Currency Variables](/api-reference/transformations/format-currency-locale-currency).
</Info>
