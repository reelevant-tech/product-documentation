...
<Info>
  Outbound Datasource fetches originate from the [Reelevant public IPs](/advanced-guide/datahub/public-ips). Allow those addresses if the remote host restricts inbound traffic.
</Info>
