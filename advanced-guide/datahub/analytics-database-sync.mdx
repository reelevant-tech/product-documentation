...
|--------|--------------------------|-------------|
| **user** | User or Purchase User | The user identifier. |
| **price** | Price | The item price. |
| **reference_id** | Reference ID or Reference IDs | The product reference purchased. |
| **transaction_id** | Transaction ID | The transaction identifier grouping items in a single order. |
| **transaction_source** | Transaction Source | The origin of the transaction (e.g., online, in-store). |
| **transaction_metadata** | Transaction Metadata | Additional transaction metadata, stored as a structured string. |
