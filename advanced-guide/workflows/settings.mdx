...
<Note>
  Branch categories are configured together with tags in [Analytics Settings](/product-guide/analytics/settings), grouping the whole qualification nomenclature in one place.
</Note>
