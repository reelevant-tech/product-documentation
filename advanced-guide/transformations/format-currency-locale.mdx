...
<Info>
  For formatting with both locale and currency code from variables, see [Format Currency with Locale and Currency Variables](/api-reference/transformations/format-currency-locale-currency).
</Info>
