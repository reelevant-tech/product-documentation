...
| Field | Description |
|-------|-------------|
| **Group prefix** | A prefix for the consumer group name. Use this if your Kafka cluster enforces naming conventions for consumer groups. |

### Schema Registry

If your Kafka messages use Avro serialization with a Confluent Schema Registry:
...
5. Fields are extracted and made available for [mapping](/platform-guide/datahub/field-mapping).
