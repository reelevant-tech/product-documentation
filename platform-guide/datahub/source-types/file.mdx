...
<Steps>
  ...
  <Step title="Configure field mapping">
    Once the file is parsed, fields are extracted and displayed. Configure the [field mapping](/platform-guide/datahub/field-mapping) to define how data should be imported.
  </Step>
...
Once you have the credentials, upload a file using any standard FTP or SFTP client:

<Tabs>
  <Tab title="SFTP">
    ```bash
    sftp -P 22 ${datasource_id}@ftp.reelevant.com <<EOF
