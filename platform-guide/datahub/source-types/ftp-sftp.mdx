...
FTP and SFTP sources support fetching **PGP-encrypted files**. When a PGP private key is configured, files are decrypted transparently before decompression and parsing.
