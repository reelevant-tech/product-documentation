...
<Info>
  File-based connectors (URL, FTP/SFTP, GCS, S3) also support [PGP decryption](/platform-guide/datahub/pgp-decryption) — encrypted files (`.asc`, `.pgp`, `.gpg`) are decrypted transparently during import when a PGP private key is configured.
</Info>
