...
| **Output** (content icon) | Open the content types drawer to add [visual content](/platform-guide/workflows/output-nodes/visual-content), [JSON format](/platform-guide/workflows/output-nodes/json-format), or [empty](/platform-guide/workflows/output-nodes/empty) output nodes. |
