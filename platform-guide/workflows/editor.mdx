...
![Workflow editor canvas with toolbar and connected nodes](https://app.devin.ai/attachments/cc43b992-ada2-4585-a549-4568fceea89d/screenshot_329fb945cec9405190c31b1238919c78.png)
...
| Tool | Description |
|------|-------------|
| **Channel** (smartphone icon) | Open the channel picker to add an entrypoint node. |
| **Data** (database icon) | Hover to reveal the data node menu — datasources, URL parameters, geolocation, weather, transforms, etc. |
| **Output** (content icon) | Open the content types drawer to add visual content, JSON format, or empty output nodes. |
