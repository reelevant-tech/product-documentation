...
<CardGroup cols={2}>
  ...
  <Card title="Output Nodes" icon="square-check">
    Define what gets returned — a content template, a JSON payload, or an empty response.
  </Card>
</CardGroup>
...
Branches can be:
- **Qualified** with a category (e.g., "Promotion", "New Arrivals") using the Branch Category Nomenclature.
