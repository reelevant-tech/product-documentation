...
4. Choose a category from the nomenclature, and optionally give the branch a custom name.

## Branch Category Nomenclature

The **Branch Category Nomenclature** is a hierarchical tree of categories that you define in [Workflow Settings](/platform-guide/workflows/settings). It provides a consistent vocabulary for qualifying branches across all your workflows.
...
- The nomenclature is shared across all workflows in your account. Design your category tree to be general enough to apply across campaigns.
