...
![Workflow editor showing multiple branches through the workflow graph](https://app.devin.ai/attachments/cc43b992-ada2-4585-a549-4568fceea89d/screenshot_329fb945cec9405190c31b1238919c78.png)

## What are Branches?

A **branch** is a unique execution path through a workflow, from a channel (entrypoint) node to an output node. When a user triggers a workflow, the engine evaluates conditions and data to determine which branch to follow, then returns the output at the end of that branch.
...
The **branch categories** are a hierarchical tree of categories that you define in [Workflow Settings](/platform-guide/workflows/settings). They provide a consistent vocabulary for qualifying branches across all your workflows.
