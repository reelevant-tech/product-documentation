...
- Use different [data nodes](/platform-guide/workflows/data-nodes) and logic branches to create variety in inbox content.
- Consider time-based [conditions](/platform-guide/workflows/logic-nodes/conditions) to refresh inbox content periodically.
