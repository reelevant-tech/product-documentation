...
![Workflow editor showing Datasource nodes connected to the workflow](https://app.devin.ai/attachments/cc43b992-ada2-4585-a549-4568fceea89d/screenshot_329fb945cec9405190c31b1238919c78.png)

## Overview

Datasource nodes connect to data you've imported in [DataHub](/platform-guide/datahub/overview). There are three specialized types, each optimized for a specific data category.
...
<Tip>
  Combine a Location Datasource with a [Geolocation](/platform-guide/workflows/data-nodes/geolocation) node to automatically find stores near the user's current position.
</Tip>
