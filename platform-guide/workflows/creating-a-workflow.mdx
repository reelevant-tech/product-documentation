...
![Workflow listing page showing the Reelevant platform sidebar](/images/workflows/workflow-sidebar.png)
...
Once your workflow is created, head to the [Workflow Editor](/platform-guide/workflows/editor) to start adding [channels](/platform-guide/workflows/channels), [data nodes](/platform-guide/workflows/data-nodes), and [logic](/platform-guide/workflows/logic-nodes).
