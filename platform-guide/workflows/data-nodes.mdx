...
- **Ordering** — Customize result order: keep default, shuffle every 10 seconds for everyone, or randomize per individual.
...
- **Shuffle** — Randomize results every 10 seconds for all users.
- **Randomize per person** — Each user sees a different order.
