...
<CardGroup cols={2}>
  <Card title="Datasource Nodes" icon="database" href="/platform-guide/workflows/data-nodes/datasources">
    Connect to data imported in DataHub — generic, product, and location datasources.
  </Card>
  <Card title="URL Parameter" icon="link" href="/platform-guide/workflows/data-nodes/url-parameter">
    Capture values passed via the URL when the workflow is executed.
  </Card>
  <Card title="Geolocation" icon="location-dot" href="/platform-guide/workflows/data-nodes/geolocation">
    Resolve the user's geographic location based on their IP address.
  </Card>
  <Card title="Weather" icon="cloud-sun" href="/platform-guide/workflows/data-nodes/weather">
    Fetch current weather data for the user's location.
  </Card>
  <Card title="Website Events" icon="chart-line" href="/platform-guide/workflows/data-nodes/website-events">
    Retrieve user behavior data from your website tracking.
  </Card>
  <Card title="Transform" icon="wand-magic-sparkles" href="/platform-guide/workflows/data-nodes/transform">
