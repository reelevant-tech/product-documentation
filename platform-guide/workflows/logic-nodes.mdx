...
![Workflow editor showing logic nodes including conditions and splits](https://app.devin.ai/attachments/cc43b992-ada2-4585-a549-4568fceea89d/screenshot_329fb945cec9405190c31b1238919c78.png)
...
<CardGroup cols={3}>
  <Card title="Conditions" icon="code-branch" href="/platform-guide/workflows/logic-nodes/conditions">
    Evaluate rules to decide which branch a user takes.
  </Card>
  <Card title="Split (A/B Testing)" icon="chart-pie" href="/platform-guide/workflows/logic-nodes/split">
    Divide traffic into branches based on population share percentages.
  </Card>
  <Card title="Real-Time Testing" icon="flask" href="/platform-guide/workflows/logic-nodes/real-time-testing">
