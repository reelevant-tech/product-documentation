---
title: 'Client-Side Personalisation'
description: 'Integrate Reelevant personalisation on the client side using the tracking script and browser extension'
---

## Overview

Client-side personalisation uses a JavaScript tracking script that loads in the browser. It fetches personalised content after the page renders and injects it into designated DOM zones. This is the original integration method and works alongside the [server-side Web SDK](/platform-guide/web-sdk/overview).
...
|----------|---------------------|
| Content that must be visible immediately (no flash) | [Server-side SDK](/platform-guide/web-sdk/overview) |
| SEO-critical personalised content | [Server-side SDK](/platform-guide/web-sdk/overview) |
...
| Quick integration without code changes | Client-side script + [Browser Extension](/platform-guide/browser-extension/overview) |
...
The [Reelevant Browser Extension](/platform-guide/browser-extension/overview) provides a no-code way to configure client-side integrations:
...
<Steps>
  ...
  <Step title="Select a workflow">
    In the extension side panel, browse your [workflow list](/platform-guide/browser-extension/workflows) and select the one to integrate.
  </Step>
  <Step title="Configure the integration">
    Use the [DOM selector](/platform-guide/browser-extension/content-script) to visually pick the HTML element where content should be injected. Configure [datalayer variables and filter conditions](/platform-guide/browser-extension/integration).
  </Step>
  <Step title="Save">
