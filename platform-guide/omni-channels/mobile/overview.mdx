...
<CardGroup cols={2}>
  <Card title="Reelevant Mobile SDK" icon="code" href="/platform-guide/omni-channels/mobile/sdk/overview">
    Official SDKs for iOS, Android, and Flutter. Combines analytics and personalisation in a single package with typed responses, auto identity, and click tracking.
  </Card>
  <Card title="Reelevant as API (JSON)" icon="mobile" href="/platform-guide/omni-channels/mobile/api-json/overview">
    Call the Reelevant runner directly via HTTP and receive structured JSON data. No SDK dependency required.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="SDK Integration" icon="code" href="/platform-guide/omni-channels/mobile/sdk/overview">
    Get started with the official SDKs — typed responses, auto identity, click tracking, and fallback strategies.
  </Card>
  <Card title="Raw API" icon="brackets-curly" href="/platform-guide/omni-channels/mobile/api-json/overview">
