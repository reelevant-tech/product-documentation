...
The Image component displays static or dynamic images in your content template. Images can come from a direct upload, a pasted URL, or a [datasource](/platform-guide/contents/data-binding) variable that resolves to an image URL at render time.
