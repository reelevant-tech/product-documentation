...
A condition is attached to a component or [group](/platform-guide/contents/layers) in the layers tree. When the content is rendered:
...
<Steps>
  <Step title="Select a component or group">
    Click the component in the [layers tree](/platform-guide/contents/layers) or on the canvas.
  </Step>
  ...
  <Step title="Configure the condition rule">
    Define the data test by selecting a [datasource](/platform-guide/contents/data-binding) variable and a comparison operator.
  </Step>
...
<Tip>
  Apply conditions to [groups](/platform-guide/contents/layers) to control the visibility of multiple components at once.
</Tip>
